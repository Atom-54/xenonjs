const graph = {
  ...
  "state":{
    ...
    "ImageComposite$ImageComposite$opB":"destination-out",
    "ImageComposite$ImageComposite$opC":"destination-over",
    "FragmentShader$shader$defaultShader":"Heartfelt Rainy Window",
    "PointerPoms$PointerPoms$penSize":10,
    "TheImage$image$selfie":true,
  ...
  "connections":{
    ...
    "TheImage$image$image":"ImageComposite$ImageComposite$output",
    "ImageComposite$ImageComposite$imageA":"FragmentShader$shader$outputImage",
    ...
    "ImageComposite$ImageComposite$imageC":"FrameCapture$FrameCapture$frame",
