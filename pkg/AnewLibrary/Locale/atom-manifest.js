...
export const LocaleNodeTypes = {
  ...
  //   },
  //   type: '$anewLibrary/Locale/Atoms/MyLocationNode'
  // },
  // ChooseLocation: {
  //   categories: [category],
  ...
  //     location$live: 'Boolean'
  //   },
  //   type: '$anewLibrary/Locale/Atoms/ChooseLocationNode'
  // },
  GoogleMap: {
    categories: [category],
  ...
  Weather: {
    ...
    type: '$anewLibrary/Locale/Atoms/WeatherNode',
  ...
  //     poi$radius: 'Number'
  //   },
  //   type: '$anewLibrary/Locale/Atoms/POI',
  //   ligature: 'public'
  // },
